...
/**
 * En este archivo configuramos el tyni editor para lograr implementarlo en el personalizar
 */
...
if (class_exists('WP_Customize_Control')) {
    class WP_Customize_Teeny_Control extends WP_Customize_Control {
      ...
      function render_content() {
        ...
        ?>
          <label>
            <span class="customize-text_editor" style="display: block; margin-bottom: 10px; font-weight: bold;"><?php echo esc_html($this->label); ?></span>
