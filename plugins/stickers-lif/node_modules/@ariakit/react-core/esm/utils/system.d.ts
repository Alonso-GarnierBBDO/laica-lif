...
export declare function createStoreContext<T extends Store>(providers?: StoreProvider<T>[], scopedProviders?: StoreProvider<T>[]): {
    ...
    ContextProvider: (props: React.ProviderProps<T | undefined>) => import("react/jsx-runtime").JSX.Element;
    ScopedContextProvider: (props: React.ProviderProps<T | undefined>) => import("react/jsx-runtime").JSX.Element;
};
export {};
