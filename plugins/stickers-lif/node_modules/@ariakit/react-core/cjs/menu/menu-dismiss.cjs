...
var _G2U3D7Y6cjs = require('../__chunks/G2U3D7Y6.cjs');


var _6RYSMHQYcjs = require('../__chunks/6RYSMHQY.cjs');
require('../__chunks/ZL7HIJU2.cjs');
require('../__chunks/ZZHSM37C.cjs');
...
var useMenuDismiss = _Z5PUIG6Acjs.createHook.call(void 0, 
  (_a) => {
    ...
    store = store || context;
    props = _G2U3D7Y6cjs.useHovercardDismiss.call(void 0, _72I2GWXFcjs.__spreadValues.call(void 0, { store }, props));
    return props;
  }
);
var MenuDismiss = _Z5PUIG6Acjs.createComponent.call(void 0, (props) => {
