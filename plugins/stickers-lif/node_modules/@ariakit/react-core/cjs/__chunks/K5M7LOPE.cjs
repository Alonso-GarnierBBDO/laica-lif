...
function useCollectionStoreProps(store, update, props) {
  _5WLTMVVQcjs.useUpdateEffect.call(void 0, update, [props.store]);
  _UHRHLHM2cjs.useStoreProps.call(void 0, store, props, "items", "setItems");
  return store;
}
function useCollectionStore(props = {}) {
  const [store, update] = _UHRHLHM2cjs.useStore.call(void 0, Core.createCollectionStore, props);
