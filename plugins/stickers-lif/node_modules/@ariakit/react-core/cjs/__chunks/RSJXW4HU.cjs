...
var _ZBG4TGVLcjs = require('./ZBG4TGVL.cjs');


var _JDIVO6OKcjs = require('./JDIVO6OK.cjs');


var _HIGZ476Mcjs = require('./HIGZ476M.cjs');
...
function useMenuStoreProps(store, update, props) {
  ...
  store = _JDIVO6OKcjs.useCompositeStoreProps.call(void 0, store, update, props);
  store = _HIGZ476Mcjs.useHovercardStoreProps.call(void 0, store, update, props);
  _UHRHLHM2cjs.useStoreProps.call(void 0, store, props, "values", "setValues");
...
function useMenuStore(props = {}) {
  const parent = _6RYSMHQYcjs.useMenuContext.call(void 0, );
  const menubar = _6RYSMHQYcjs.useMenuBarContext.call(void 0, );
  const combobox = _ZBG4TGVLcjs.useComboboxProviderContext.call(void 0, );
  ...
  const [store, update] = _UHRHLHM2cjs.useStore.call(void 0, Core.createMenuStore, props);
