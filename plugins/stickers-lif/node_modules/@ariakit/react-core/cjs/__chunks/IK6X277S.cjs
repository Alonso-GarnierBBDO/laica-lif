...
var _VI6T32XIcjs = require('./VI6T32XI.cjs');


var _XH2CZ7VFcjs = require('./XH2CZ7VF.cjs');



var _AKOG5S2Tcjs = require('./AKOG5S2T.cjs');
...
var usePopoverDisclosure = _Z5PUIG6Acjs.createHook.call(void 0, 
  (_a) => {
    var _b = _a, { store } = _b, props = _72I2GWXFcjs.__objRest.call(void 0, _b, ["store"]);
    const context = _AKOG5S2Tcjs.usePopoverProviderContext.call(void 0, );
    store = store || context;
    ...
    props = _5WLTMVVQcjs.useWrapElement.call(void 0, 
      props,
      (element) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _AKOG5S2Tcjs.PopoverScopedContextProvider, { value: store, children: element }),
      [store]
    );
    props = _72I2GWXFcjs.__spreadProps.call(void 0, _72I2GWXFcjs.__spreadValues.call(void 0, {}, props), {
      onClick
    });
    props = _XH2CZ7VFcjs.usePopoverAnchor.call(void 0, _72I2GWXFcjs.__spreadValues.call(void 0, { store }, props));
    props = _VI6T32XIcjs.useDialogDisclosure.call(void 0, _72I2GWXFcjs.__spreadValues.call(void 0, { store }, props));
    return props;
  }
);
var PopoverDisclosure = _Z5PUIG6Acjs.createComponent.call(void 0, 
  (props) => {
