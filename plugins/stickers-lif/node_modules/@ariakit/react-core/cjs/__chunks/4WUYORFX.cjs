...
var _NHZBX2RScjs = require('./NHZBX2RS.cjs');
...
function useCollectionRenderer(_a) {
  ...
  var _a2, _b2;
  const context = _NHZBX2RScjs.useCollectionContext.call(void 0, );
  store = store || context;
  const items = _UHRHLHM2cjs.useStoreState.call(void 0, 
    store,
...
var CollectionRenderer = _Z5PUIG6Acjs.forwardRef.call(void 0, function CollectionRenderer2(props) {
