...
var useDialogDismiss = _Z5PUIG6Acjs.createHook.call(void 0, 
  (_a) => {
    var _b = _a, { store } = _b, props = _72I2GWXFcjs.__objRest.call(void 0, _b, ["store"]);
    const context = _W6ZRSMO5cjs.useDialogScopedContext.call(void 0, );
    store = store || context;
...
var DialogDismiss = _Z5PUIG6Acjs.createComponent.call(void 0, (props) => {
