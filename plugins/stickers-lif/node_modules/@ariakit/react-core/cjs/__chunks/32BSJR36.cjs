...
var useComboboxList = _Z5PUIG6Acjs.createHook.call(void 0, 
  (_a) => {
    ...
    props = _5WLTMVVQcjs.useWrapElement.call(void 0, 
      props,
      (element) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _ZBG4TGVLcjs.ComboboxScopedContextProvider, { value: store, children: element }),
      [store]
    );
    ...
    props = _GQAB4M3Bcjs.useFocusable.call(void 0, _72I2GWXFcjs.__spreadValues.call(void 0, { focusable }, props));
    return props;
  }
);
var ComboboxList = _Z5PUIG6Acjs.createComponent.call(void 0, (props) => {
