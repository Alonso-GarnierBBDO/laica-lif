...
var _FXRXBA2Ycjs = require('./FXRXBA2Y.cjs');


var _FMI5QF7Ncjs = require('./FMI5QF7N.cjs');
...
var _H7R5D2FRcjs = require('./H7R5D2FR.cjs');
...
var _UHRHLHM2cjs = require('./UHRHLHM2.cjs');
...
var useCompositeItem = _Z5PUIG6Acjs.createHook.call(void 0, 
  (_a) => {
    var _b = _a, {
      store,
      rowId: rowIdProp,
    ...
    const context = _H7R5D2FRcjs.useCompositeContext.call(void 0, );
    store = store || context;
    const id = _5WLTMVVQcjs.useId.call(void 0, props.id);
    const ref = _react.useRef.call(void 0, null);
    const row = _react.useContext.call(void 0, _H7R5D2FRcjs.CompositeRowContext);
    const rowId = _UHRHLHM2cjs.useStoreState.call(void 0, store, (state) => {
      if (rowIdProp)
        return rowIdProp;
      if (!state)
        return;
    ...
    const baseElement = _UHRHLHM2cjs.useStoreState.call(void 0, 
      store,
    ...
    props = _5WLTMVVQcjs.useWrapElement.call(void 0, 
      props,
      (element) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _H7R5D2FRcjs.CompositeItemContext.Provider, { value: providerValue, children: element }),
      [providerValue]
    );
    const isActiveItem = _UHRHLHM2cjs.useStoreState.call(void 0, 
      store,
      (state) => !!state && state.activeId === id
    );
    const virtualFocus = _UHRHLHM2cjs.useStoreState.call(void 0, store, "virtualFocus");
    ...
    const ariaSetSize = _UHRHLHM2cjs.useStoreState.call(void 0, store, (state) => {
    ...
    const ariaPosInSet = _UHRHLHM2cjs.useStoreState.call(void 0, store, (state) => {
    ...
    const isTabbable = _UHRHLHM2cjs.useStoreState.call(void 0, store, (state) => {
    ...
    props = _FXRXBA2Ycjs.useCommand.call(void 0, props);
    props = _FMI5QF7Ncjs.useCollectionItem.call(void 0, _72I2GWXFcjs.__spreadProps.call(void 0, _72I2GWXFcjs.__spreadValues.call(void 0, {
      store
    }, props), {
      getItem,
...
var CompositeItem = _Z5PUIG6Acjs.createMemoComponent.call(void 0, 
  (props) => {
