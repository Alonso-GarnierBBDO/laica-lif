...
var _4WUYORFXcjs = require('./4WUYORFX.cjs');
...
function findById(items, id, baseId) {
  return items.findIndex((item, index) => {
    var _a;
    const itemId = _4WUYORFXcjs.getCollectionRendererItemId.call(void 0, item, index, baseId);
    if (itemId === id)
      return true;
    const object = getItemObject(item);
...
function useCompositeRenderer(_a) {
  ...
  store = store || context;
  const orientation = _UHRHLHM2cjs.useStoreState.call(void 0, 
    store,
  ...
  const items = _UHRHLHM2cjs.useStoreState.call(void 0, store, (state) => {
    var _a2;
    if (!state)
      return props.items;
  ...
  const activeId = _UHRHLHM2cjs.useStoreState.call(void 0, store, "activeId");
  ...
  return _4WUYORFXcjs.useCollectionRenderer.call(void 0, _72I2GWXFcjs.__spreadProps.call(void 0, _72I2GWXFcjs.__spreadValues.call(void 0, {
    id,
    store,
    orientation,
    persistentIndices
...
var CompositeRenderer = _Z5PUIG6Acjs.forwardRef.call(void 0, function CompositeRenderer2(props) {
