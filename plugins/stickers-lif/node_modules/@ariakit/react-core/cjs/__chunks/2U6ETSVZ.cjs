...
var _I2EPCLS6cjs = require('./I2EPCLS6.cjs');
...
var useSelectList = _Z5PUIG6Acjs.createHook.call(void 0, 
  (_a) => {
    var _b = _a, {
      store,
      resetOnEscape = true,
    ...
    const resetOnEscapeProp = _5WLTMVVQcjs.useBooleanEvent.call(void 0, resetOnEscape);
    const hideOnEnterProp = _5WLTMVVQcjs.useBooleanEvent.call(void 0, hideOnEnter);
    ...
    props = _5WLTMVVQcjs.useWrapElement.call(void 0, 
      props,
      (element) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _I2EPCLS6cjs.SelectScopedContextProvider, { value: store, children: element }),
      [store]
    );
    ...
    if (composite) {
      props = _72I2GWXFcjs.__spreadValues.call(void 0, { role: "listbox" }, props);
    }
    const role = _5WLTMVVQcjs.useAttribute.call(void 0, ref, "role", props.role);
    ...
    props = _SELCJFCBcjs.useComposite.call(void 0, _72I2GWXFcjs.__spreadProps.call(void 0, _72I2GWXFcjs.__spreadValues.call(void 0, { store }, props), { composite }));
...
var SelectList = _Z5PUIG6Acjs.createComponent.call(void 0, (props) => {
