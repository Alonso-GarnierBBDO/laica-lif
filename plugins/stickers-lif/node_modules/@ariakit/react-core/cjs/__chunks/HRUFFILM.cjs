...
function useDisclosureStoreProps(store, update, props) {
  ...
  _UHRHLHM2cjs.useStoreProps.call(void 0, store, props, "open", "setOpen");
  _UHRHLHM2cjs.useStoreProps.call(void 0, store, props, "mounted", "setMounted");
  _UHRHLHM2cjs.useStoreProps.call(void 0, store, props, "animated");
  return store;
}
function useDisclosureStore(props = {}) {
  const [store, update] = _UHRHLHM2cjs.useStore.call(void 0, Core.createDisclosureStore, props);
