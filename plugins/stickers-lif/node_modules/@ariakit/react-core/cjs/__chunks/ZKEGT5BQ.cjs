...
var useCompositeContainer = _Z5PUIG6Acjs.createHook.call(void 0, 
  (_a) => {
    ...
    const renderedItems = _UHRHLHM2cjs.useStoreState.call(void 0, store, "renderedItems");
...
var CompositeContainer = _Z5PUIG6Acjs.createMemoComponent.call(void 0, (props) => {
