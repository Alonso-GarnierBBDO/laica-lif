...
var useSelectItem = _Z5PUIG6Acjs.createHook.call(void 0, 
  (_a) => {
    var _b = _a, {
      store,
      value,
    ...
    var _a2;
    const context = _I2EPCLS6cjs.useSelectScopedContext.call(void 0, );
    store = store || context;
    ...
    props = _5WLTMVVQcjs.useWrapElement.call(void 0, 
      props,
      (element) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _I2EPCLS6cjs.SelectItemCheckedContext.Provider, { value: selected, children: element }),
      [selected]
    );
    ...
    props = _D3SPQ2OYcjs.useCompositeItem.call(void 0, _72I2GWXFcjs.__spreadValues.call(void 0, {
      store,
      getItem,
      preventScrollOnKeyDown
    }, props));
...
var SelectItem = _Z5PUIG6Acjs.createMemoComponent.call(void 0, (props) => {
