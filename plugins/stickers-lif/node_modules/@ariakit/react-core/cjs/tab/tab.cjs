...
var useTab = _Z5PUIG6Acjs.createHook.call(void 0, 
  (_a) => {
    var _b = _a, {
      store,
    ...
    const context = _HBZJ2UC5cjs.useTabScopedContext.call(void 0, );
    store = store || context;
...
var Tab = _Z5PUIG6Acjs.createMemoComponent.call(void 0, (props) => {
