<?php
    ...
    class ScreenWidgets extends WP_Widget {

        // Constructor
        public function __construct() {
            parent::__construct(
                'noticias_lif', // ID único para el widget
                'Screens LIF', // Nombre del widget visible en el panel de control
                array(
                    'description' => 'Contiene las screens de LIF' // Descripción del widget
                )
            );
        }
