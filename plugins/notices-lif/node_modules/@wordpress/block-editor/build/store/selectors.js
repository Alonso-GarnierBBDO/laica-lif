...
const __experimentalUserPatternCategories = (0, _rememo.default)(state => {
  return state?.settings?.__experimentalUserPatternCategories;
}, state => [state.settings.__experimentalUserPatternCategories]);
exports.__experimentalUserPatternCategories = __experimentalUserPatternCategories;
...
const isUngroupable = (0, _data.createRegistrySelector)(select => (state, clientId = '') => {
 ...
 */
exports.isUngroupable = isUngroupable;
const isGroupable = (0, _data.createRegistrySelector)(select => (state, clientIds = EMPTY_ARRAY) => {
  const {
    getGroupingBlockName
  } = select(_blocks.store);
  const groupingBlockName = getGroupingBlockName();
